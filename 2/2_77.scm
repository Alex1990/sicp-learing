...
; - (apply (lambda (. args) (apply-generic 'magnitude . args)) ('rectangular 3 4)))
...
;  5
;
;  3 times apply-generic
;
;  First: complex package magnitude
;  Second: complex-number package magnitude
;  Third: rectangular package magnitude
